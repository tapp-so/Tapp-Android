...
class Tapp(context: Context) {
    ...
    init {
        ...
        AffiliateServiceFactory.register(com.example.tapp.models.Affiliate.APPSFLYER) { deps -> com.example.tapp.services.affiliate.appsflyer.AppsflyerAffiliateService(deps) }
    }
